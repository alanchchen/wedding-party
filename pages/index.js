...
export default function Index() {
  return (
    <>
      {/* <IndexNavbar fixed /> */}
      {/* <section className="header relative items-center md:flex h-screen">
        <div class="md:container md:mx-auto items-center flex flex-wrap justify-center ">
          <img
            src="/img/wedding-party-cover.png"
            alt="..."
            class="shadow rounded b-auto align-middle border-none"
          />
        </div>
        <div className="md:container md:mx-auto items-center flex flex-wrap">
          <div className="w-full px-4">
            <div className="pt-8 sm:pt-0">
              ...
              <div className="md:container md:mx-auto items-center content-center flex mt-4">
                <button
                  class="sm:mx-auto bg-blueGray-400 text-white active:bg-blueGray-600 font-bold uppercase text-base px-3 py-4 rounded shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
                >
                  領取您的婚禮小物
                </button>
              ...
              <div className="w-11/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blueGray-700">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <button
                      class="w-full bg-blueGray-400 text-white active:bg-blueGray-600 font-bold uppercase text-base px-3 py-4 rounded shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 mt-8"
                      type="button"
                    >
                      領取您的婚禮小物
                    </button>
